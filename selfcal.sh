...
# scale = 0.5 / chan
wsclean -name wsclean-${i} -multiscale -mgain 0.85 -pol xx,xy,yx,yy -joinpolarizations -weight uniform -size 8000 8000 -scale 0.0034 -niter 1000000 -auto-threshold 5 -auto-mask 8 $absmem ${obsid}.ms
